...
This example shows the moon phase context for **London on October 10, 1993 at 12:12 UTC** -- a Waning Crescent phase with 32% illumination. The response includes both AI-optimized XML context and full JSON moon phase data.
